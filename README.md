...
<p>
  ...
  <img alt="版本" src="https://img.shields.io/badge/当前版本-v0.1.8-0f766e">
...
- `LuminaLink-Setup-0.1.8-x64.exe`：安装版
- `LuminaLink-Portable-0.1.8-x64.exe`：免安装版
...
4. 需要翻译时，在设置里配置 Provider，然后点击 **翻译此项** 或 **翻译前 10 个**。
